<?php include 'header.php'; ?>
	...
	<div class="container-fluid">
		<div class="row">
		 ...
		 <div class="col-md-8">
			<img src="./img/title_join_min.png" alt="logo_bronycub" class="img-responsive" />
			<hr />
			...
			<p>
				...
				Si vous n’habitez pas dans le coin, nous vous invitons à rejoindre le <a href="http://carte.leponeyblanc.fr">collectif brony de votre région</a>.
			</p>
			...
			<blockquote class="pull-right">
				<p>... il peut y avoir de la honte à être heureux tout seul.</p>
			...
			<h3>Localisation</h3>
				...
				<h3>L'histoire</h3>
					<p>
						Le site de BronyCUB est chargé d'histoire car il est notre coeur de communication.
					</p>
					...
					<div id="myTabContent" class="tab-content">
						...
						<div class="tab-pane fade" id="ticket">
							...
							<p>
								Donc pour toute demande concernant le collectif, <a href="https://bronycub.freshdesk.com/support/tickets/new">ouvrez un ticket</a> ! Des responsables vous répondront le plus rapidement possible pour vous aider !
							</p>
						</div>
						...
						<p>
							...
							<ul>
								...
								<li>Gordfang : Aide précieuse dans la gestion du collectif.</li>
								<li>SebWhooves : Référent des 23h de la BD et pâtissier du collectif.</li>
								<li>Électron : Gestion du tchat IRC et du serveur Minecraft/Mumble.</li>
								<li>Wildfier : Développeur de SugarCUB, rien que ça !</li>
								<li>Shinsaber : Notre généreux super admin sys.</li>
								<li>Fidzu : Notre chinois-portugais.</li>
								<li>TrappyTickles : Référents du BBBFF qui se la pète avec son tatoo !</li>
								<li>Panda : Community Manager du collectif en voie d’extinction.</li>
								<li>Aragox : Maître des Jeux de Sociétés.</li>
								<li>Elvon : Organisateur de la mort qui tue des voyages en convention.</li>
